...
" // TODO:␣
inoremap <c-d> TODO:<Space><Esc>:Commentary<CR>A
" // FIXME:␣
inoremap <c-x> FIXME:<Space><Esc>:Commentary<CR>A
" // NOTE:␣
inoremap <c-e> NOTE:<Space><Esc>:Commentary<CR>A
" /** (JS JSDoc / block comment)
" NOTE: Tried to use <c-s> here ("jS", more ergonomic), but for some reason VSCodeVim doesn't support <c-s>. So we just use B so that it's consistent in both runtimes
inoremap <c-b> /**
" // **tl;dr:**␣ 
inoremap <c-t> **tl;dr:**<Space>
