...
// UPDATE: Tried doing this manually and it still doesn't work. Going to have to look into this more at some point...

const { execSync } = require("child_process");

// Customize
// ===
const DIR = "~/personal"; // TODO: Maybe take from args?
const PASSWORD =
  process.env.SUDO_PASSWORD ||
  "FILL_PASSWORD_HERE_BUT_FFS_DON_NOT_SHARE_IT_ANYWHERE"; // TODO: Better security, see note about sudo-prompt
